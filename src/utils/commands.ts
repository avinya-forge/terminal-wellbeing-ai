 ...
 */
async function handleNoteCommand(parsed: ParsedCommand): Promise<string> {
 ...
 */
async function handleListNotesCommand(): Promise<string> {
 ...
 */
async function handleDeleteNoteCommand(parsed: ParsedCommand): Promise<string> {
 ...
 */
async function handleClearNotesCommand(): Promise<string> {
